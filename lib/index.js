  ...
  async activate() {
    if (inkdrop && !inkdrop.isMobile) {
      ...
      if (backupPath) {
        ...
        inkdrop.layouts.insertComponentToLayoutAfter(_restore_sidebar.default.layoutName, "SideBarMenuItemTrash", _restore_sidebar.default.componentName);
        inkdrop.components.registerClass(_restore_modal.default);
        inkdrop.layouts.addComponentToLayout("modal", _restore_modal.default.name); // Sync stuff on changes:
