            ...
            try {
              ...
              switch (typeOfChange) {
                case "note":
                  ...
                  try {
                    noteAlreadyExists = await fs.promises.access(notePath);
                  ...
                  if (change !== null && change !== void 0 && (_change$doc = change.doc) !== null && _change$doc !== void 0 && _change$doc.title) {
                    ...
                    if ((_utilities$dataMap$no = _utilities.default.dataMap.notes[change.id]) !== null && _utilities$dataMap$no !== void 0 && _utilities$dataMap$no.title && change.doc.title !== _utilities.default.dataMap.notes[change.id].title) {
                      ...
                      await fs.promises.rename(`${bookPath}/${oldDataMap.notes[change.id].title}.md`, notePath);
                    }
                ...
                case "book":
                  if (_utilities.default !== null && _utilities.default !== void 0 && (_utilities$dataMap = _utilities.default.dataMap) !== null && _utilities$dataMap !== void 0 && _utilities$dataMap.books[change.id] && change !== null && change !== void 0 && (_change$doc2 = change.doc) !== null && _change$doc2 !== void 0 && _change$doc2.name && change.doc.name !== path.basename(_utilities.default.dataMap.books[change.id])) {
                    const oldDataMap = await _utilities.default.getDataMap(plainTextPath);
                    await fs.promises.rename(`${plainTextPath}/${oldDataMap.books[change.id]}`, `${plainTextPath}/${change.doc.name}`);
