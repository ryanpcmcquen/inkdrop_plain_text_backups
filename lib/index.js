    ...
    if (inkdrop && !inkdrop.isMobile) {
      ...
      if (backupPath) {
        ...
        this.disposable.onChange(async change => {
          var _change$doc, _utilities$dataMap$no, _utilities$dataMap$no2, _change$doc2;
          ...
          try {
            ...
            switch (typeOfChange) {
              case "note":
                ...
                if (change !== null && change !== void 0 && (_change$doc = change.doc) !== null && _change$doc !== void 0 && _change$doc.title && (_utilities$dataMap$no = _utilities.default.dataMap.notes) !== null && _utilities$dataMap$no !== void 0 && (_utilities$dataMap$no2 = _utilities$dataMap$no[change.id]) !== null && _utilities$dataMap$no2 !== void 0 && _utilities$dataMap$no2.title && change.doc.title !== _utilities.default.dataMap.notes[change.id].title) {
