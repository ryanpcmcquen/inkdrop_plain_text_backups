  ...
  async activate() {
    if (inkdrop && !inkdrop.isMobile) {
      ...
      if (backupPath) {
        ...
        await _utilities.default.getDataAndWriteAllNotes(self.disposable, plainTextPath);
        ...
        try {
          ...
          self.disposable.onChange(async change => {
            var _change$doc, _utilities$dataMap$no, _utilities$dataMap, _change$doc2;
              ...
              switch (typeOfChange) {
                ...
                case "book":
                  if (_utilities.default !== null && _utilities.default !== void 0 && (_utilities$dataMap = _utilities.default.dataMap) !== null && _utilities$dataMap !== void 0 && _utilities$dataMap.books[change.id] && change !== null && change !== void 0 && (_change$doc2 = change.doc) !== null && _change$doc2 !== void 0 && _change$doc2.name && change.doc.name !== path.basename(_utilities.default.dataMap.books[change.id])) {
                    ...
                    let bookPath = await _utilities.default.getBookPath(self.disposable, change.doc);
