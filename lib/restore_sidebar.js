...
class RestoreSidebar extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleClick", () => {
      _restore_modal.default.open(); // this.setState({ modalIsOpen: !this.state.modalIsOpen });
...
_defineProperty(RestoreSidebar, "componentName", RestoreSidebar.name);

var _default = RestoreSidebar;
exports.default = _default;
//# sourceMappingURL=restore_sidebar.js.map