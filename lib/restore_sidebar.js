...
exports.componentName = exports.layoutName = exports.show = exports.hide = exports.toggle = exports.default = void 0;
...
function RestoreSidebar() {
  ...
  return /*#__PURE__*/React.createElement(SideBarMenuItem, {
    ...
    indentLevel: 0,
    onClick: handleClick,
    renderIcon: () => /*#__PURE__*/React.createElement("i", {
...
const hide = () => {
  inkdrop.layouts.removeComponentFromLayout(layoutName, (void 0).componentName);
};

exports.hide = hide;

const show = () => {
  inkdrop.layouts.insertComponentToLayoutAfter(layoutName, "SideBarMenuItemTrash", componentName);
};
